 ...
 */
@Immutable
public final class MimeMagicMatcherBinarySerializer implements BinarySerializer {

  public static final MimeMagicMatcherBinarySerializer INSTANCE =
      new MimeMagicMatcherBinarySerializer();
